...
def create_model(
    ...
    return UNetModel(
        ...
        out_channels=(in_chans if not learn_sigma else 2*in_chans),
...
def create_classifier(
    ...
    **kwargs,
    ...
    return EncoderUNetModel(
        image_size=image_size,
        in_channels=in_channels if not kwargs.get('classifier_in_channels', None) else kwargs['classifier_in_channels'],
